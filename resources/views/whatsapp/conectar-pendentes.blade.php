<x-app-layout>
    <div class="space-y-4">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
                <h1 class="text-xl font-bold text-gray-900 dark:text-gray-100">Conectar WhatsApp — Pendentes</h1>
                <p class="text-xs text-gray-600 dark:text-gray-400 mt-0.5">Enviar mensagens para devedores com dívidas pendentes</p>
            </div>
        </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Dívidas Pendentes</th>
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse($devedores as $devedor)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                    {{ $devedor->dividas->count() }} dívida(s)
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                    R$ {{ number_format($devedor->dividas->sum('valor_divida'), 2, ',', '.') }}
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">
                                    Nenhum devedor com dívidas pendentes encontrado.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
